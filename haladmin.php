            ...
            <div class="col-md-10 col-md-offset-2">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="beranda.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/home.png" width="70" alt="...">
                            <small>BERANDA</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="data_pengguna.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/user.png" width="70" alt="...">
                            <small>DATA PENGGUNA</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="data_odjg.php" class="thumbnail text-center" style="border: 0px;">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="modul.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/modul.png" width="70" alt="...">
                            <small>MODUL</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="ecoaching.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/video.png" width="70" alt="...">
                            <small>E-COACHING</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="interaktif.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/speak.png" width="70" alt="...">
                            <small>INTERAKTIF PETUGAS</small>
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="interaktif2.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/speak.png" width="70" alt="...">
                            <small>INTERAKTIF KELUARGA</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="kuesioner_app.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/list.png" width="70" alt="...">
                            <small>KUESIONER APP</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="kuesioner_tugas_keluarga.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/list.png" width="70" alt="...">
