...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Daftar Inputan Perawat</h3>
        </div>
        <hr>
            ...
            <div class="panel-heading" style="background-color: #6ae6c2; color: black;">
                ...
                <?php if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) { ?>
                    <?php if ($_GET['keyword1'] || $_GET['keyword2']) { ?>
                        <a href="hasil2.php"><button type="button" class="btn btn-warning">Tampil Semua Data</button></a>
                    <?php } ?>
                <?php } ?>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) {
                                $wilayah  = $_GET['keyword1'];
                                $nama     = $_GET['keyword2'];
                                $data = mysqli_query($connection, "select * from user where nama like '%" . $nama . "%' and puskesmas like '%" . $wilayah . "%' and level = 'Perawat'");
                            } else {
                                $data = mysqli_query($connection, "select * from user where level ='Perawat' and puskesmas = '$puskesmas' ");
                            }
                            $no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="tema3.php?username=<?= $d['username'] ?>" class="btn btn-primary btn-sm">Lihat</a></td>
                                </tr>
                            <?php
                            }
                            ?>
