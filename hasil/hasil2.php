    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color: #6ae6c2; color: black;">
                <a href="inputanPerawat.php?username=<?= $_SESSION['username'] ?>" class="btn btn-success btn-sm">Lihat inputan perawat</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) {
                                ...
                                $data = mysqli_query($connection, "select * from user where level ='Keluarga' and puskesmas = '$puskesmas' ");
                            }
                            $no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="tema.php?username=<?= $d['username'] ?>" class="btn btn-primary btn-sm">Lihat</a></td>
                                </tr>
                            <?php
                            }
                            ?>
