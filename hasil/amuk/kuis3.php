...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Amuk/Perilaku Kekerasan - <?= $tugas ?></h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <a href="tgl3.php?id=<?= $id_tema ?>&username=<?= $username ?>&id_kuis=<?= $id_kuis ?>"><button type="button" class="btn btn-warning btn-lg btn-block ">Kembali</button></a><BR>
            </div>
        </div>
