    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="panel panel-default">
                        ...
                        while ($data = mysqli_fetch_array($tes)) { ?>
                            <li class="list-group-item" style="background-color: #6ae6c2;">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="kuis3.php?id=<?= $id_tema ?>&username=<?= $username ?>&id_kuis=<?= $id_kuis ?>&id_hasil=<?= $data['id_hasil'] ?>" class="label label-success">Lihat</a>
                                </div>
                            </li>
                            <br>
                        <?php $i++;
            ...
            <div class="panel-footer">
                ...
                <a href="../amuk3.php?id=<?= $id_tema ?>&username=<?= $username ?>"><button type="button" class="btn btn-warning btn-lg btn-block ">Kembali</button></a><BR>
            </div>
        </div>
