  ...
  <div class="container" style="margin-top:60px">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <a href="tambahodgj.php"><button type="button" class="btn btn-primary">Tambah ODGJ</button></a>

        <?php if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) { ?>
          <?php if ($_GET['keyword1'] && $_GET['keyword2']) { ?>
            <div class="pull-right">
              <a href="data_odjg.php"><button type="button" class="btn btn-warning">Tampil Semua Data</button></a>
            </div>
          <?php } ?>
        <?php } ?>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><a href="editodgj.php?id=<?php echo $d['nik']; ?>"><button type="button" class="btn btn-warning">EDIT</button></a>
                    <a href="hapusodgj.php?id=<?php echo $d['nik']; ?>"><button type="button" class="btn btn-danger">HAPUS</button></a>
                  </td>
                </tr>
              <?php
              }
