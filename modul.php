            ...
            <div class="col-md-10 col-md-offset-2">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="resiko.php?id=1" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/search.png" width="70" alt="...">
                            <small>Amuk/Perilaku Kekerasan</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="resiko.php?id=2" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/search.png" width="70" alt="...">
                            <small>Halusinasi</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="resiko.php?id=3" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/search.png" width="70" alt="...">
                ...
                <div class="row ">
                    <div class="col-xs-4 col-md-3">
                        <a href="resiko.php?id=4" class="thumbnail text-center " style="border: 0px;">
                            <img src="assets/img/icon/search.png" width="70" alt="...">
                            <small>Harga Diri Rendah</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="resiko.php?id=5" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/search.png" width="70" alt="...">
                            <small>Kurang Perawatan Diri</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="modul_kesehatan_jiwa.php" class="thumbnail text-center" style="border: 0px;">
