	...
	<div class="container" style="margin-top:40px">
		...
		<div class="panel panel-default">
				...
				<div class="form-bottom">
					<form role="form" action="" method="post" class="login-form">
						...
						<div class="form-group">
							...
							<textarea rows="3" name="status" class="form-control" placeholder="Status saat ini"></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="puskesmas" class="form-control" required value="<?= $_SESSION['puskesmas'] ?>" readonly>
						</div>
			...
			<div class="panel-footer">
				<a href="data_odjg_kader.php"><button type="button" class="btn btn-block btn-warning btn-lg">Kembali</button></a>
			</div>
		</div>
