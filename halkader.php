            ...
            <div class="col-md-10 col-md-offset-2">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="olah_akun_kader.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/gear.png" width="70" alt="...">
                            <small>AKUN KADER</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="data_odjg_kader.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/odgj.png" width="70" alt="...">
                            <small>DATA ODGJ</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="5tugas_kader.php" class="thumbnail text-center" style="border: 0px;">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="interaktif4.php" class="thumbnail text-center" style="border: 0px;">
