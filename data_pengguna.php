  ...
  <div class="container" style="margin-top:60px">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <a href="tambahpengguna.php"><button type="button" class="btn btn-primary" style="margin-bottom: 10px;">Tambah Pengguna</button></a>

        <?php if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) { ?>
          <?php if ($_GET['keyword1'] && $_GET['keyword2']) { ?>
            <div class="pull-right">
              <a href="data_pengguna.php"><button type="button" class="btn btn-warning">Tampil Semua Data</button></a>
            </div>
          <?php } ?>
        <?php } ?>
      ...
      <div class="panel-body">
        ...
        if (isset($_GET['keyword1']) && isset($_GET['keyword2'])) {
          ...
          $data = mysqli_query($connection, "select * from user where nama like '%" . $nama . "%' and puskesmas like '%" . $wilayah . "%'");
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><a href="editpengguna.php?id=<?php echo $d['username']; ?>"><button type="button" class="btn btn-warning">EDIT</button></a>
                    <a href="hapuspengguna.php?id=<?php echo $d['username']; ?>"><button type="button" class="btn btn-danger">HAPUS</button></a>
                  </td>
                </tr>
              <?php
              }
