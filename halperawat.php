            ...
            <div class="col-md-10 col-md-offset-2">
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="olah_akun_perawat.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/gear.png" width="70" alt="...">
                            <small>AKUN PERAWAT</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="olahakunkader.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/user.png" width="70" alt="...">
                            <small>AKUN PENGGUNA</small>
                        </a>
                    </div>

                    <div class="col-xs-4 col-md-3">
                        <a href="modul_perawat.php" class="thumbnail text-center" style="border: 0px;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 col-md-3">
                        <a href="data_odjg_perawat.php" class="thumbnail text-center" style="border: 0px;">
                    ...
                    <div class="col-xs-4 col-md-3">
                        <a href="ecoaching_perawat.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/video.png" width="70" alt="...">
                            <small>E-COACHING</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="interaktif3.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/speak.png" width="70" alt="...">
                            <small>INTERAKTIF KELUARGA</small>
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-4 col-md-3">
                        <a href="5tugas_perawat.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/list.png" width="70" alt="...">
                            <small>KUESIONER APLIKASI</small>
                        </a>
                    </div>
                    <div class="col-xs-4 col-md-3">
                        <a href="kuesioner_tugas_keluarga3.php" class="thumbnail text-center" style="border: 0px;">
                            <img src="assets/img/icon/list.png" width="70" alt="...">
