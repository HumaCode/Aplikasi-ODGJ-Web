...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Video E-Coaching Si Pandawa</h3>
        </div>
        <hr>
        <a href="halkeluarga.php"><button type="button" class="btn btn-warning btn-lg btn-block">Kembali</button></a><BR>

        <a href="video/pengantar_keluarga.php"><button type="button" class="btn btn-primary btn-lg btn-block" style="background-color: #6ae6c2; color: black;">Pengantar</button></a><BR>
