        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/3rlhFLpWVuc?playlist=3rlhFLpWVuc&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p>Saya dapat membentuk lingkungan yang sehat dirumah dengan : </p>

                    </div>

                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Menyediakan suasana yang mampu mengendalikan halusinasi">
                            Menyediakan suasana yang mampu mengendalikan halusinasi
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Menyediakan waktu untuk bercakap cakap ">
                            Menyediakan waktu untuk bercakap cakap
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Menyediakan  waktu untuk beraktifitas teratur">
                            Menyediakan waktu untuk beraktifitas teratur
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memberikan pujian bila berhasil mengontrol halusinasi">
                            Memberikan pujian bila berhasil mengontrol halusinasi
                        </label>
                    </div>
