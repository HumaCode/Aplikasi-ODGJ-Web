...
if (isset($_POST['kirim'])) {
    ...
    header('location:../tugas4_perawat.php?id=' . $id_kuis . '&id_tema=' . $id_tema . '');
}
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas4_perawat.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-lg btn-block " style="background-color: #6ae6c2; color: black;">Kembali</button></a><BR>
            </div>
        </div>
