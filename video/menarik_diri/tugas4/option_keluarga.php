...
if (isset($_POST['kirim'])) {
    ...
    header('location:../tugas4_keluarga.php?id=' . $id_kuis . '&id_tema=' . $id_tema . '');
}
...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Tugas 4 - Pilihan Tindakan</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/HyJ-DDLN9fI?playlist=HyJ-DDLN9fI&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p>Boleh memilih lebih dari satu : </p>

                    </div>

                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Belajar membentuk lingkungan yang sehat jiwa untuk ODGJ menarik diri">
                            Belajar membentuk lingkungan yang sehat jiwa untuk ODGJ menarik diri
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memotivasi ODGJ berinteraksi dengan orang lain dan lingkunganya ">
                            Memotivasi ODGJ berinteraksi dengan orang lain dan lingkunganya
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Menyediakan waktu untuk kegiatan bersama dan waktu untuk beraktifitas teratur">
                            Menyediakan waktu untuk kegiatan bersama dan waktu untuk beraktifitas teratur
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memberikan pujian bila berhasil berhubungan dengan orang lain">
                            Memberikan pujian bila berhasil berhubungan dengan orang lain
                        </label>
                    </div>
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas4_keluarga.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-lg btn-block " style="background-color: #6ae6c2; color: black;">Kembali</button></a><BR>
            </div>
        </div>
