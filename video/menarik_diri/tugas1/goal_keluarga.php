        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/cufnJC0CcBs?playlist=cufnJC0CcBs&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p>Saya dapat mengenal gejala menarik diri : </p>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Mengatakan ingin sendiri">
                            Mengatakan ingin sendiri
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Menyendiri">
                            Menyendiri
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Tidak ingin behubungan  dengan orang lain">
                            Tidak ingin behubungan dengan orang lain
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Malu">
                            Malu
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Minder">
                            Minder
                        </label>
                    </div>
