        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/BwurfWij2UM?playlist=BwurfWij2UM&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p>Saya dapat merawat ODGJ dengan menarik diri : </p>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Memberikan motivasi untuk berkenalan dengan orang baru">
                            Memberikan motivasi untuk berkenalan dengan orang baru
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Membuat jadual bercakap-cakap dengan keluarga dan tetangga terdekat, mengajak dalam kegiata social">
                            Membuat jadual bercakap-cakap dengan keluarga dan tetangga terdekat, mengajak dalam kegiata social
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Serta beri pujian bila dapat melakukan dengan baik">
                            Serta beri pujian bila dapat melakukan dengan baik
                        </label>
                    </div>
