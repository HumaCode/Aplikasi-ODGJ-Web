...
$sql = mysqli_query($connection, "SELECT * FROM kuis WHERE level = '$level' AND tema = 'halusinasi'") or die(mysqli_error($connection));
...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Pengantar (Halusinasi)</div>
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/u3KoOrL4T50?playlist=u3KoOrL4T50&loop=1" allowfullscreen>
                    </iframe>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="halusinasi/penutup_keluarga.php?id=<?= $id ?>"><button type="button" class="btn btn-primary btn-lg btn-block" style="background-color: #6ae6c2; color: black;">Penutup</button></a><BR>
            </div>
