...
$l = mysqli_query($connection, "SELECT * FROM hasil WHERE username = '$username' AND id_kuis = 48");
            ...
            <div class="panel-body">
                ...
                <?php if (isset($edit)) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($edit['goal'] == 'null') { ?>
                            <a href="tugas4/goal.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol1"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Tujuan</button></a><BR>
                        <?php } else { ?>
                            <a href="tugas4/goal.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol1"><button type="button" name="bt" class="btn btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Tujuan</button></a><BR>
                        <?php } ?>


                        <?php if ($edit['goal'] != 'null') { ?>
                            <?php if ($edit['real1'] == 0) { ?>
                                <a href="tugas4/real.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol2"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Kenyataan saat ini</button></a><BR>
                            <?php } else { ?>
                                <a href="tugas4/real.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol2"><button type="button" name="bt" class="btn btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Kenyataan saat ini</button></a><BR>
                            <?php } ?>
                        <?php } else { ?>
                        ...
                        <?php if (isset($edit['real1'])) { ?>
                            <?php if ($edit['real1'] != 0) { ?>
                                <?php if ($edit['option1'] == 'null') { ?>
                                    <a href="tugas4/option.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol3"><button type="button" name="bt" class="btn btn-warning  btn-lg btn-block"> Pilihan tindakan </button></a><BR>
                                <?php } else { ?>
                                    <a href="tugas4/option.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol3"><button type="button" name="bt" class="btn  btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Pilihan tindakan </button></a><BR>
                                <?php } ?>
                            <?php } else { ?>
                        ...
                        <?php if (isset($edit['option1'])) { ?>
                            <?php if ($edit['option1'] != 'null') { ?>
                                <?php if ($edit['will'] == 'null') { ?>
                                    <a href="tugas4/will.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol4"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Tindakan yang akan dilakukan</button></a><BR>
                                <?php } else { ?>

                                    <a href="tugas4/will.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol4"><button type="button" name="bt" class="btn  btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Tindakan yang akan dilakukan</button></a><BR>
                                <?php } ?>
                            <?php } else { ?>
