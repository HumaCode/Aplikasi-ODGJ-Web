...
$l = mysqli_query($connection, "SELECT * FROM hasil WHERE username = '$username' AND id_kuis = 42");
...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Kurang Perawatan Diri - Tugas 3</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/VQoamxtOrqc?playlist=VQoamxtOrqc&loop=1" allowfullscreen>
                    </iframe>
                </div>
            </div>
        </div>
