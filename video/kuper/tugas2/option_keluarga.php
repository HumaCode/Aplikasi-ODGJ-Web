        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/2tv9sr9gCDY?playlist=2tv9sr9gCDY&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Merundingkan dengan keluarga bila ada gejala kurang perawatan diri pada ODGJ">
                            Merundingkan dengan keluarga bila ada gejala kurang perawatan diri pada ODGJ
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Berunding dengan pihak terkait seperti tenga kesehatan, kader dan perangkat desa">
                            Berunding dengan pihak terkait seperti tenga kesehatan, kader dan perangkat desa
                        </label>
                    </div>
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas2_keluarga.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-lg btn-block " style="background-color: #6ae6c2; color: black;">Kembali</button></a><BR>
            </div>
        </div>
