...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Tugas 1 - Pilihan Tindakan</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/ZFegShIxYk0?playlist=ZFegShIxYk0&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memperhatikan perilaku ODGJ secara berkala">
                            Memperhatikan perilaku ODGJ secara berkala
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Berkonsultasi dengan petugas kesehatan bila ada tanda tanda yang baru">
                            Berkonsultasi dengan petugas kesehatan bila ada tanda tanda yang baru
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Mengingat dan mencatat setiap gejala baru yang muncul">
                            Mengingat dan mencatat setiap gejala baru yang muncul
                        </label>
                    </div>
