...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Tugas 5 - Tujuan</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/sjkOQFfBBWM?playlist=sjkOQFfBBWM&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <p>Saya dapat memanfaatkan fasilitas pelayanan kesehatan jiwa seperti : </p>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Puskesmas">
                            Puskesmas
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Rumah sakit">
                            Rumah sakit
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="goal[]" id="goal" value="Rumah sakit jiwa">
                            Rumah sakit jiwa
                        </label>
                    </div>
