...
if (isset($_POST['kirim'])) {
    ...
    header('location:../tugas5_keluarga.php?id=' . $id_kuis . '&id_tema=' . $id_tema . '');
}
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas5_keluarga.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-warning btn-lg btn-block ">Kembali</button></a><BR>
            </div>
        </div>
