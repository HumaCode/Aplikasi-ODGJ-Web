...
if (isset($_POST['kirim'])) {
    ...
    mysqli_query($connection, "UPDATE  hasil SET username = '$username', id_tema = '$id_tema', id_kuis = '$id_kuis', goal = '$goal', real1 = '$real', option1 = '$option', will = '$will' WHERE id_hasil = '$id_hasil'");
...
<body>
    ...
    <div class="container" style="margin-top:40px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Tugas 5 - Tindakan Yang Akan Dilakukan</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/LgR5YGoH9yU?playlist=LgR5YGoH9yU&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <p>Tuliskan tindakan yang akan di lakukan (boleh lebih dari satu pisahkan dengan tanda koma (,)) </p>
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas5_keluarga.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-lg btn-block " style="background-color: #6ae6c2; color: black;">Kembali</button></a><BR>
            </div>
        </div>
