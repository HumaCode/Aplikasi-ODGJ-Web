...
if (isset($_POST['kirim'])) {
    ...
    header('location:../tugas5_perawat.php?id=' . $id_kuis . '&id_tema=' . $id_tema . '');
}
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/mJpoBdr1VMM?playlist=mJpoBdr1VMM&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Menghubungi  petugas kesehatan bila ada gejala harga diri rendah">
                            Menghubungi petugas kesehatan bila ada gejala harga diri rendah
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memeriksakan ODGJ ke Puskesmas">
                            Memeriksakan ODGJ ke Puskesmas
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memeriksaan ODGJ ke Rumah sakit">
                            Memeriksaan ODGJ ke Rumah sakit
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Memeriksakan ODGJ ke Rumah sakit jiwa">
                            Memeriksakan ODGJ ke Rumah sakit jiwa
                        </label>
                    </div>
            ...
            <div class="panel-footer">
                ...
                <a href="../tugas5_perawat.php?id=<?= $id_kuis ?>&id_tema=<?= $id_tema ?>"><button type="button" class="btn btn-warning btn-lg btn-block ">Kembali</button></a><BR>
            </div>
        </div>
