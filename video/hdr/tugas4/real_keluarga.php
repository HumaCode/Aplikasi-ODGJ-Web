...
if (isset($_POST['kirim'])) {
    ...
    mysqli_query($connection, "UPDATE  hasil SET username = '$username', id_tema = '$id_tema', id_kuis = '$id_kuis', goal = '$goal', real1 = '$real', option1 = 'null', will = 'null' WHERE id_hasil = '$id_hasil'");
