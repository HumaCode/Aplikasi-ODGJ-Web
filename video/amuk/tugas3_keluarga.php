...
$l = mysqli_query($connection, "SELECT * FROM hasil WHERE username = '$username' AND id_kuis = 2");
...
<body>
    ...
    <div class="container" style="margin-top:60px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Amuk/Perilaku Kekerasan - Tugas 3</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/PHbK1CijC3U?playlist=PHbK1CijC3U&loop=1" allowfullscreen>
                    </iframe>
                </div>
            </div>
        </div>
            ...
            <div class="panel-body">
                ...
                <?php if (isset($edit)) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($edit['goal'] == 'null') { ?>
                            <a href="tugas3/goal_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol1"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Tujuan</button></a><BR>
                        <?php } else { ?>
                            <a href="tugas3/goal_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol1"><button type="button" name="bt" class="btn btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Tujuan</button></a><BR>
                        <?php } ?>


                        <?php if ($edit['goal'] != 'null') { ?>
                            <?php if ($edit['real1'] == 0) { ?>
                                <a href="tugas3/real_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol2"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Kenyataan saat ini</button></a><BR>
                            <?php } else { ?>
                                <a href="tugas3/real_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol2"><button type="button" name="bt" class="btn btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Kenyataan saat ini</button></a><BR>
                            <?php } ?>
                        <?php } else { ?>
                        ...
                        <?php if (isset($edit['real1'])) { ?>
                            <?php if ($edit['real1'] != 0) { ?>
                                <?php if ($edit['option1'] == 'null') { ?>
                                    <a href="tugas3/option_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol3"><button type="button" name="bt" class="btn btn-warning  btn-lg btn-block"> Pilihan tindakan </button></a><BR>
                                <?php } else { ?>
                                    <a href="tugas3/option_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol3"><button type="button" name="bt" class="btn  btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Pilihan tindakan </button></a><BR>
                                <?php } ?>
                            <?php } else { ?>
                        ...
                        <?php if (isset($edit['option1'])) { ?>
                            <?php if ($edit['option1'] != 'null') { ?>
                                <?php if ($edit['will'] == 'null') { ?>
                                    <a href="tugas3/will_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol4"><button type="button" name="bt" class="btn btn-warning btn-lg btn-block"> Tindakan yang akan dilakukan</button></a><BR>
                                <?php } else { ?>

                                    <a href="tugas3/will_keluarga.php?id_tema=<?= $id_tema ?>&id_kuis=<?= $id_kuis ?>" id="tombol4"><button type="button" name="bt" class="btn  btn-lg btn-block" style="background-color: #6ae6c2; color: black;"> Tindakan yang akan dilakukan</button></a><BR>
                                <?php } ?>
                            <?php } else { ?>
