        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    ...
                    ?>
                    <div class="pull-left">
                        <p style="margin: -25px 40px 10px;">Selamat Datang <?php echo $_SESSION['nama']; ?></p>
                    </div>
                </a>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/TSniABshO9E?playlist=TSniABshO9E&loop=1" allowfullscreen>
                    </iframe>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Merundingkan dengan keluarga bila ada gejala amuk pada ODGJ">
                            Merundingkan dengan keluarga bila ada gejala amuk pada ODGJ
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="option[]" id="option" value="Berunding dengan pihak terkait seperti tenga kesehtan, kader dan perangkat desa">
                            Berunding dengan pihak terkait seperti tenga kesehtan, kader dan perangkat desa
                        </label>
                    </div>
