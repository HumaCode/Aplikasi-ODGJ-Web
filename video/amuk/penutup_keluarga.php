...
<body>
    ...
    <div class="container" style="margin-top:40px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>Penutup - Amuk/Perilaku Kekerasan</h3>
        </div>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe src="https://www.youtube.com/embed/gBkQ_uQuFzs?playlist=gBkQ_uQuFzs&loop=1" allowfullscreen>
                    </iframe>
                </div>
            </div>
            <div class="panel-footer">

                <a href="../amuk_keluarga.php?id=<?= $id ?>"><button type="button" class="btn btn-warning btn-lg btn-block ">Kembali</button></a><BR>
            </div>
        </div>
