...
<body>
    ...
    <div class="container" style="margin-top:40px">
        ...
        <div class="d" style="background-color: #6ae6c2; padding:10px;">
            ...
            <h3 align=center>UPDATE DATA PENGGUNA</h3>
        </div>
        <hr>
            ...
            <div class="panel-body">
                <div class="form-bottom">
                    ...
                    <form role="form" action="" method="post">
                        <?php
                        $id = $_GET['id'];
                        $data = mysqli_query($connection, "select * from user where username='$id'");
                        ...
                        ?>
                            ...
                            <button type="submit" name="submit" class="btn btn-primary">Update Pengguna!</button>
                        <?php
                        }
                        ?>
                    </form>
